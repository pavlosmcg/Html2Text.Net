...
public class ParserTests
{
    ...
    [Test]
    public void ParseHtml_Returns_Nodes_IgnoringTagsInsideComments()
    {
        // arrange
        var html = "<span>some text<!--a comment </span><p> over some markup </p> --> and more after comment</span>";
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result[0].TagName, Is.EqualTo("span"));
            Assert.That(result[0].Children?.Count,Is.EqualTo(2));
            Assert.That(result[0].Children?[0].Text,Is.EqualTo("some text"));
            Assert.That(result[0].Children?[1].Text,Is.EqualTo(" and more after comment"));
        });
    }

    [Test]
    public void ParseHtml_Returns_Nodes_WithTextForInvalidCommentsInsideTags()
    {
        // arrange
        var html = "<span><p <!-- comment inside p tag --> >text inside p tag</p></span>";
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result[0].TagName, Is.EqualTo("span"));
            Assert.That(result[0].Children?.Count, Is.EqualTo(2));
            Assert.That(result[0].Children?[0].Text, Is.EqualTo("<p <!-- comment inside p tag -->"));
            Assert.That(result[0].Children?[1].Text, Is.EqualTo(" >text inside p tag"));
        });
    }

    [Test]
    public void ParseHtml_Returns_Nodes_WithTextForInvalidCommentStartingInsideTagAndEndingAfterTag()
    {
        // arrange
        var html = "<span><p <!-- >comment  -->text</p></span>";
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result[0].TagName, Is.EqualTo("span"));
            Assert.That(result[0].Children?.Count, Is.EqualTo(2));
            Assert.That(result[0].Children?[0].Text, Is.EqualTo("<p <!-- >"));
            Assert.That(result[0].Children?[1].Text, Is.EqualTo("comment  -->text"));
        });
    }

    [Test]
    public void ParseHtml_Returns_Nodes_IgnoringCommentsThatEndInsideOpeningTags()
    {
        // arrange
        var html = "<span><!-- comment <p-->>paragraph</p></span>";
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result[0].TagName, Is.EqualTo("span"));
            Assert.That(result[0].Children?.Count, Is.EqualTo(1));
            Assert.That(result[0].Children?[0].Text, Is.EqualTo(">paragraph"));
        });
    }

    [Test]
    public void ParseHtml_Returns_Nodes_IgnoringCommentsThatEndInsideClosingTags()
    {
        // arrange
        var html = "<span><p><!-- comment </p-->></span>";
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result[0].TagName, Is.EqualTo("span"));
            Assert.That(result[0].Children?.Count, Is.EqualTo(1));
            Assert.That(result[0].Children?[0].TagName, Is.EqualTo("p"));
            Assert.That(result[0].Children?[0].Children?[0].Text, Is.EqualTo(">"));
        });
    }

    // TODO in the above case and other tests where we have multiple closing tags, kick out the spurious closing tags as text (maybe)
}
